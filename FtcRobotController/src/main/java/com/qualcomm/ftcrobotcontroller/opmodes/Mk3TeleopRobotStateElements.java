...
public class Mk3TeleopRobotStateElements
{
    ...
    public static int robot_state_size = 156;
    ...
    public static void set_shoulder_potentiometer(int value)
    {
        ByteBuffer.wrap(robot_state, 28, 4).order(ByteOrder.nativeOrder()).putInt(value);
    }

    public static int get_shoulder_potentiometer()
    {
        return ByteBuffer.wrap(robot_state, 28, 4).order(ByteOrder.nativeOrder()).getInt();
    }
    ...
    public static void set_current_color(int value)
    {
        ByteBuffer.wrap(robot_state, 52, 4).order(ByteOrder.nativeOrder()).putInt(value);
    }

    public static int get_current_color()
    {
    ...
    public static void set_hook_right(float value)
    {
    ...
    {
        ByteBuffer.wrap(robot_state, 124, 4).order(ByteOrder.nativeOrder()).putInt(value);
    }

    public static int get_gamepad1_buttons()
    {
        return ByteBuffer.wrap(robot_state, 124, 4).order(ByteOrder.nativeOrder()).getInt();
    }
    ...
    {
        ByteBuffer.wrap(robot_state, 148, 4).order(ByteOrder.nativeOrder()).putFloat(value);
    }

    public static float get_gamepad2_trigger2()
    {
        return ByteBuffer.wrap(robot_state, 148, 4).order(ByteOrder.nativeOrder()).getFloat();
    }

    public static void set_gamepad2_buttons(int value)
    {
        ByteBuffer.wrap(robot_state, 152, 4).order(ByteOrder.nativeOrder()).putInt(value);
    }

    public static int get_gamepad2_buttons()
    {
        return ByteBuffer.wrap(robot_state, 152, 4).order(ByteOrder.nativeOrder()).getInt();
    }
